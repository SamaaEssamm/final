...
import { FaArrowLeft, FaPaperclip, FaUser, FaUserSecret, FaLightbulb, FaHeadset, FaShieldAlt, FaExclamationTriangle } from "react-icons/fa";
...
export default function NewSuggestionPage() {
    ...
    // إصلاح مشكلة النص العربي - دالة محسنة للتحقق من النص
    const isMeaningfulText = (text: string) => {
        const cleaned = text.trim();
        
        // تحقق من وجود نص عربي أو إنجليزي
        const hasArabic = /[\u0600-\u06FF]/.test(cleaned);
        const hasEnglish = /[a-zA-Z]/.test(cleaned);
        
        if (!hasArabic && !hasEnglish) return false;
        
        // تحقق من عدد الكلمات (كلمات حقيقية وليس مسافات فقط)
        const words = cleaned.split(/\s+/).filter(word => {
            // تجاهل الكلمات التي تحتوي على أحرف غير مرغوب فيها فقط
            return word.length > 0 && /[\w\u0600-\u06FF]/.test(word);
        });
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            const res = await fetch(`${api}/api/student/addsuggestion`, {
                method: 'POST',
                body: data,
            });
    ...
    return (
        ...
        >
            {/* Large Lightbulb Marks in Background */}
            <div className="absolute top-20 left-16 opacity-20">
                <FaLightbulb className="text-blue-300 text-[200px]" />
            </div>
            <div className="absolute bottom-32 right-20 opacity-20">
                <FaLightbulb className="text-blue-300 text-[180px] rotate-45" />
            </div>
            <div className="absolute top-1/2 left-1/3 opacity-20">
                <FaLightbulb className="text-blue-300 text-[160px] -rotate-25" />
            </div>
            <div className="absolute top-1/4 right-1/4 opacity-20">
                <FaLightbulb className="text-blue-300 text-[140px] rotate-12" />
            </div>
            ...
            <div className="hidden lg:flex lg:w-2/5 flex-col justify-center p-12 text-white">
                <div className="mb-10">
                    <div className="flex items-center mb-6">
                        <FaLightbulb className="text-blue-300 text-4xl mr-4" />
                        <h1 className="text-4xl font-bold">Share Your Idea</h1>
                    </div>
                    <p className="text-xl text-blue-200 mb-8">
                        Your suggestions help us improve and innovate. We value every idea you share with us.
                    </p>
                </div>
                ...
                <div className="space-y-6">
                    <div className="flex items-start">
                        ...
                        <div>
                            <h3 className="font-semibold text-lg mb-1">Innovation Matters</h3>
                            <p className="text-blue-200">Your ideas drive positive change and improvement.</p>
                        </div>
                    </div>
                    ...
                    <div className="flex items-start">
                        ...
                        <div>
                            <h3 className="font-semibold text-lg mb-1">Implementation Focus</h3>
                            <p className="text-blue-200">We review all suggestions for potential implementation.</p>
                        </div>
                    </div>
                </div>
                ...
                <div className="mt-12 p-6 bg-blue-800/30 rounded-2xl border border-blue-600/30">
                    <h3 className="font-bold text-lg mb-3 flex items-center">
                        <FaLightbulb className="mr-2 text-blue-300" />
                        Before Submitting
                    </h3>
                    <ul className="text-blue-200 space-y-2">
                        <li className="flex items-start">
                            <span className="text-blue-300 mr-2">•</span>
                            Be specific and detailed in your suggestion
                        </li>
                        <li className="flex items-start">
                            <span className="text-blue-300 mr-2">•</span>
                ...
                <div className="w-full max-w-2xl">
                    ...
                    <div className="lg:hidden mb-8 text-center">
                        <div className="inline-flex items-center justify-center p-3 bg-blue-500/20 rounded-full mb-4">
                            ...
                            <h1 className="text-2xl font-bold text-white">Submit a Suggestion</h1>
                        </div>
                        <p className="text-blue-200">Share your ideas to help us improve</p>
                    </div>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6" encType="multipart/form-data">
                            ...
                            <div className="bg-white p-4 rounded-xl border border-blue-100 shadow-sm">
                                <label className="block text-sm font-medium text-blue-900 mb-2 flex items-center">
                                    <FaLightbulb className="text-blue-600 mr-2 text-sm" />
                                    Suggestion Title *
                                </label>
                                <input
                                    type="text"
                            ...
                            <div className="bg-white p-4 rounded-xl border border-blue-100 shadow-sm">
                                ...
                                <textarea
                                    ...
                                    rows={6}
                                    required
                                    placeholder="Please describe your suggestion in detail. Explain how it could benefit the community and how it might be implemented."
                                    className="w-full border border-blue-200 rounded-lg px-4 py-3 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200"
                                />
                                    ...
                                    <div className="mt-3 p-3 bg-yellow-50 border border-yellow-200 rounded-lg">
                                        <div className="flex items-start">
                                            ...
                                            <p className="text-sm text-yellow-700">
                                                ...
                                                your identity will be visible to the department handling your suggestion.
                                            </p>
                                        </div>
                                    </div>
                                )}
